...
def main():
    ...
    recordings_params['spiketrains']['n_exc'] = 70
    recordings_params['spiketrains']['n_inh'] = 150
    ...
    recgen = mr.gen_recordings(templates='templates/OrgMEA_n60_templates_e256.h5', params=recordings_params)
    ...
    mr.save_recording_generator(recgen, filename='recordings/OrgMEA_recording_test_03.h5')
